(ns social.mushin.alternative.undertow
  (:require
    [clojure.tools.logging :as log]
    [integrant.core :as ig]
    [ring.adapter.undertow :refer [run-undertow]]))

;; This code comes from https://github.com/kit-clj/kit/blob/bf96b3e5c07e87862416a5990cbc8d480394f754/libs/kit-undertow/src/kit/edge/server/undertow.clj
