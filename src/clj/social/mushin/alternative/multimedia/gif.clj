(ns social.mushin.alternative.multimedia.gif
  (:require [clojure.java.io :as io]
            [java-time.api :as time]
            [social.mushin.alternative.utils :refer [condj]]
            [social.mushin.alternative.geom :as geom]
            [social.mushin.alternative.with-disposable :refer [with-disposable]]
            [social.mushin.alternative.files :as files]
            [social.mushin.alternative.multimedia.svg :as svg]
            [social.mushin.alternative.multimedia.captions :as caption]
            [clojure.math :as math]
            [social.mushin.alternative.multimedia.colorspace :as cs]
