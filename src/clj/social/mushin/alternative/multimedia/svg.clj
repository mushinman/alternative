(ns social.mushin.alternative.multimedia.svg
  (:require [clojure.java.io :as io]
            [social.mushin.alternative.acc :refer [postwalk-noassoc mapv-acc]]
            [social.mushin.alternative.multimedia.buffered-image-transcoder :as bit]
